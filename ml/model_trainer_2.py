...
DATA_FILE = "auv_training_data_10_min.csv"
...
def train_lc_model():
    ...
    joblib.dump(lc_svm, "lc_model_small.joblib")
    joblib.dump(lc_scaler, "lc_scaler_small.joblib")
    print("Saved 'lc_model_small.joblib' and 'lc_scaler_small.joblib'.")
    return True
...
def train_oc_model():
    ...
    # 7. Save Model and Scaler
    joblib.dump(oc_svm, "oc_model_small.joblib")
    joblib.dump(oc_scaler, "oc_scaler_small.joblib")
    print("Saved 'oc_model_small.joblib' and 'oc_scaler_small.joblib'.")
    return True
